...
const About = forwardRef<HTMLElement>((_, ref) => {
  return (
    <>
      ...
      >
        <div className="bg-black bg-opacity-40 p-3 sm:p-4 md:p-6 rounded-2xl max-w-full sm:max-w-sm md:max-w-md">
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-4">About Fertigenyx</h2>
