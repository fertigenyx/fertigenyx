...
<div className='scroll-m-16 scroll-smooth mt-12' id='know-more'>
      <div className='relative bg-transparent dark:bg-gray-800 lg:pt-4'>
        <div className='container relative m-auto px-3 md:px-12 lg:px-6'>
          <h2 className='mx-auto lg:text-center font-heading text-2xl lg:text-5xl font-black  text-brandPurpleDark'>
            What is IVF and how does it work ?
          </h2>{' '}
            <div className='grid grid-cols-1 lg:grid-cols-2 justify-center items-center text-base'>
              <div className='mx-auto ml-0 text-left font-content md:max-w-lg lg:max-w-2xl'>
                <p className=''>
                To conceive. IVF or In Vitro Fertilization is one of the more widely known types of Assisted Reproductive Techniques (ART). It involves retrieving eggs from the woman&apos;s ovaries and fertilizing them with sperm in a laboratory dish. The resulting embryos are then transferred back into the woman&apos;s uterus in the hope of achieving a successful pregnancy. 
                  <br />
                  <br />
