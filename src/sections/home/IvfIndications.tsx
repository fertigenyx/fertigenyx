...
const IvfIndications= forwardRef<HTMLElement>((_, ref) =>  {
    const infertilityData = [
      ...
      },
      {
        ...
        content:
          'If the cause of infertility is unknown, IVF may be recommended..',
      },
      {
        key: 'infertility4',
    ...
    return (
      <section ref={ref} id="ivf-and-its-indications" className='mx-auto lg:my-10 max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8'>
        <h2 className='mt-10 text-left text-brandPurpleDark font-heading text-2xl lg:text-5xl font-extrabold tracking-tight sm:text-4xl lg:text-center'>
        ...
        <div className='mx-auto max-w-7xl px-3'>
          <div className='py-3 lg:pt-8'>
            <div className='font-content'>
              <div className='pb-4'>
              First step towards infertility is correct diagnosis and NOT treatment. Some common reasons for recommending IVF include:
              </div>
            </div>
