...
'IUI (Intrauterine Insemination) is a fertility treatment procedure in which sperm is placed directly inside a womans uterus to increase the chance of pregnancy. It is a relatively simple and low-invasive procedure, often used in cases of infertility caused by issues with ovulation, sperm count, or cervical mucus. It may be used alone or in combination with other fertility medications such as ovulation induction medications. The success rate of IUI varies depending on the individual patients circumstances, and it is typically more successful when performed in conjunction with other fertility treatments.']
      },
      {
        id: '3',
        name: 'ICSI',
        icon: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739847606/ICSI_buxnjt.png',
        icon1: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739856994/ICSI_1_ghpwcc.png',
        link: '/treatments/icsi-treatment-in-bangalore',
        content: ['ICSI, or intracytoplasmic sperm injection, is a powerful assisted reproductive technology that has helped many couples overcome male infertility. During ICSI treatment, a single sperm is injected directly into the egg, which increases the chance of fertilization.', 'Our team of experienced and compassionate doctors will guide you through the ICSI process, answering any questions you may have along the way. Trust us to help you achieve your dream of parenthood with ICSI treatment in Bangalore.']
      },
      {
        id: '4',
        name: 'Infertility',
        icon: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739847605/Infertility_1_ceien8.png',
        icon1: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739856993/Infertility_2_ytggxm.png',
        link: '/treatments/infertility-treatment-in-bangalore',
        content:['FertiGenyx - Your Path to Parenthood Begins Here. Discover Advanced infertility solutions Today!',

'Our expert team of fertility specialists utilizes advanced medical techniques and state-of-the-art facilities to diagnose and address various infertility issues. With a personalized approach, we tailor treatment plans to meet the unique needs of each individual, maximizing the chances of successful conception and a healthy pregnancy.']
      },
     
      {
        id: '5',
        name: 'Hysteroscopy',
        icon: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739847606/Hysteroscopy_odmrbc.png',
        icon1: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739856992/Hysteroscopy_1_tqbrjg.png',
        link: '/treatments/hysteroscopy-treatment-in-bangalore',
        content:['Hysteroscopy involves using a thin, lighted tube called a hysteroscope to examine the inside of the uterus. This procedure can be both diagnostic and operative, allowing for a clear view and immediate treatment of issues such as abnormal bleeding, fibroids, and polyps. We have experienced specialists to do this procedure.']
      },
      {
        id: '6',
        name: 'Laparoscopy',
      ...
      },
      {
        id: '7',
        name: 'PESA & TESA',
        icon: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739847605/PESA_TESA_dc3a1z.png',
        icon1: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739856989/PESA_TESA_1_bzvuly.png',
        link: '/treatments/pesa-and-tesa',
        content:['PESA is a simple procedure that involves inserting a needle into the epididymis to extract fluid that contains sperm. ','TESE: Similar to PESA, testicular sperm aspiration (TESA) is also one of the newest methods used in the treatment of infertility in men. ','The testes of the male reproductive system play an important role as they produce sperms, hence it is of utmost significance to ensure that testes are healthy. Nothing to be surprised about, there do exist certain conditions where your testes could be producing the sperms but they are unable to flow into the semen. A special technique of sperm retrieval is used in the treatment process during an IVF cycle where the sperm is directly harvested from the testicles and used for fertilization of the egg in a laboratory.  Two such extensively utilized techniques are TESA (Testicular Sperm Aspiration) and PESA (Percutaneous Epididymal Sperm Aspiration).']
      },
      {
        id: '8',
        name: 'FET',
      ...
      },
      {
        id: '13',
        name: 'MACS',
        icon: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739847605/Macs_s9ca8m.png',
        icon1: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739856989/Macs_1_xiqaqh.png',
        link: '/treatments/macs',
        content:['Magnetic Activated Cell Sorting is a procedure that isolates the healthy sperms from the unhealthy sperms. MACS procedure allows choosing the most viable sperm for successful fertilization.','Magnetic Activated Cell Sorting (MACS) is an immunomagnetic technique that enables the selection of the sperms that shows no signs of cell damage or death (also called apoptosis) which means their entire DNA remains intact.','For achieving pregnancy through ART (Assisted Reproductive Techniques) the most crucial factor is the quality of the semen. Among the various factors which affect the quality of the semen, Apoptotic sperm is one among them.','The Apoptotic sperm may be removed from the sample using this method as their cell membranes contain the markers that may be detected. ','The quality of the semen may be improved by this technique. Magnetic-activated cell sorting is one of the most efficient methods for the reduction of sperm DNA fragmentation in men with varicocele before performing Assisted Reproductive Techniques. The semen parameters in men with varicocele exhibit higher level of abnormalities which include apoptotic markers, DNA fragmentation, etc']
      },
      {
        id: '14',
        name: 'Semen Freezing',
        icon: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739847604/Semen_Freezing_eqntvb.png',
        icon1: 'https://res.cloudinary.com/garbhagudiivf/image/upload/v1739856989/Semen_Freezing_1_gsh0hj.png',
        link: '/treatments/semen-freezing',
        content:['Semen freezing is a procedure used to preserve male fertility. Sperm freezing or Semen Cryopreservation is a way for men to conserve their sperm and collect it in a bank so that it may be utilized in the future.','Men can choose to freeze their sperm before getting any medical treatments which may damage sperm quality, like several types of cancer treatment like chemotherapy and radiation.']
      }   
    ]
