        ...
        <div className='relative px-4 sm:px-6 lg:px-8'>
          <div className='mx-auto max-w-7xl text-lg'>
            ...
            <div className='mx-auto mt-6 max-w-7xl text-gray-800'>
              ...
              <p className='mt-4 font-content text-lg'>
              We firmly believe in protecting the personal information of the customer. We or any of its staff or official will never ask for any password or related information from its customers and the customers are also advised, in order to protect access to their accounts and to other channels, do not disclose the passwords to anyone.We will not sell, distribute or lease your personal information to third parties unless we have your permission or are required by law to do so. We may use your personal information to send you promotional information about third parties which we think you may find interesting if you tell us that you wish this to happen. We undertake not to disclose the information provided by the customer to any person unless such action is necessary to the extent required by law and for regulatory purposes. If you believe that any information we are holding on you is incorrect or incomplete, contact us as soon as possible, at the above address. We will promptly correct any information found to be incorrect.
              </p>
            </div>
          </div>
        </div>
